...
class KeyZIO(object):
    ...
    def inject_user_key(self, user_private_key_pem):
    ...
    def _init_cipher(self, key_id):
        ...
        raw_key = self._user_private_key.decrypt(base64.b64decode(key_json['cipher_key']))
        iv = base64.b64decode(key_json['cipher_iv'])
